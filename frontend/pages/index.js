...
export async function getServerSideProps() {
  try {
    ...
    const apiBaseUrl = serverRuntimeConfig.API_INTERNAL_BASE_URL || publicRuntimeConfig.API_BASE_URL;
    const response = await axios.get(`${apiBaseUrl}/api/v1/featured-rooms-list`);
